...
// Initialize the GoogleGenAI client lazily at runtime to avoid crashes when the
// API key is missing in local/dev. We create it only when needed.
...
async function fetchInsights(): Promise<Insight[]> {
  try {
    ...
    // FIX: Use ai.models.generateContent with the correct model and config for a JSON response, as per guidelines.
